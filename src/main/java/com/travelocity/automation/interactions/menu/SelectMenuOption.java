package com.travelocity.automation.interactions.menu;
...
import static com.travelocity.automation.userinterfaces.menu.Menu.*;
...
public class SelectMenuOption implements Interaction {
  ...
  public <T extends Actor> void performAs(T actor) {
    actor.attemptsTo(
        ...
        Click.on(MENU_OPTIONS.of(menuOption)),
        Click.on(SUBMENU_OPTION.of(submenuOption))
    );
  }
